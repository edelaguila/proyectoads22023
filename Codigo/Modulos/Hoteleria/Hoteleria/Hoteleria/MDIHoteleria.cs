...
{
    public partial class MDIHoteleria : Form
    {
        ...
        private void openForm(Form frm)
        {
            ...
            frm.FormClosed += FormHijo_FormClosed;
            frm.MdiParent = this;
            frm.Show();
            hideSubMenu();
            current = frm;
        ...
        {
            this.openForm(new ReservaHabitacion());
        ...
        {
            this.openForm(new ReservacionSalon());
        }

        private void button2_Click(object sender, EventArgs e)
        {
            this.openForm(new GestionHuespedes());
        }

        private void button4_Click(object sender, EventArgs e)
        {
            this.openForm(new GestionHabitaciones());
        }

        private void button3_Click(object sender, EventArgs e)
        {
            this.openForm(new Habitacion());
        }
    }
}
